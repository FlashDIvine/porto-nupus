...
export function GalleryFilter({
  ...
  return (
    <div
      className={cn(
        'sticky top-[76px] sm:top-[82px] z-30 w-full py-2.5 sm:py-3 px-2 sm:px-4 backdrop-blur-xl bg-[#FAF8F5]/90 border-b border-[#E6E2D8]/80 transition-all duration-300 shadow-[0_4px_24px_rgba(24,23,22,0.03)]',
        className
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        {/* Editorial Taxonomy Label */}
        <div className="hidden lg:flex items-center gap-2 text-xs font-mono text-[#6B6661] shrink-0 pr-3 border-r border-[#E6E2D8]">
          <SlidersHorizontal className="w-3.5 h-3.5 text-[#E26D5C]" />
          <span>{isId ? 'Kategori Kurasi' : 'Curated Categories'}</span>
        </div>
        ...
        <div
          ...
          role="tablist"
          aria-label="Filter kategori karya pilihan"
          className="flex items-center gap-2 overflow-x-auto scrollbar-none scroll-smooth py-1 w-full"
          style={{
            scrollbarWidth: 'none',
        ...
        >
          ...
          >
            {activeCategory === 'All' && (
              <motion.div
                layoutId="active-gallery-filter-pill"
